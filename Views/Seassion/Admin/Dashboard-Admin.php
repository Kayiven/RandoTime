...
$stmt = $pdo->query("SELECT id, nom, prenom, email, telephone, role FROM compte ORDER BY role");
...
<div class="dashboard-wrapper">
  <div class="sidebar">
    ...
    <div class="submenu">
      <a href="./Dashboard-Admin.php" class="active">View Comptes</a>
  ...
  <div class="dashboard-content">
    <h2 class="title-db">👥 Liste des Comptes</h2>
      ...
      <table class="dashboard-table">
        ...
        <tbody>
          <?php if (!empty($comptes)): ?>
            ...
            <?php endforeach; ?>
          <?php else: ?>
            <tr><td colspan="6" style="text-align:center;">Aucun compte trouvé.</td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </div>
