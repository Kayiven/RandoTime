...
$stmt = $pdo->query("SELECT id, nom, email, Title,	telephone, sujet, date FROM contact");
...
<div class="dashboard-wrapper">
  <div class="sidebar">
    ...
    <div class="submenu">
      ...
      <a href="./Dashboard-Contact.php" class="active">View Contact</a>
  ...
  <div class="dashboard-content">
    <h2 class="title-db">👥 Liste des Contacts</h2>
          ...
          <?php if (!empty($Contacts)): ?>
            <?php foreach ($Contacts as $Contacts): ?>
              <tr>
                ...
                <td><?= htmlspecialchars($Contacts['Title']) ?></td>
                <td><?= htmlspecialchars($Contacts['telephone']) ?></td>
                <td><?= htmlspecialchars($Contacts['sujet']) ?></td>
                <td><?= htmlspecialchars($Contacts['date']) ?></td>
              </tr>
            <?php endforeach; ?>
          <?php else: ?>
