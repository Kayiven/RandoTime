...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/plage_tabarka.webp" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/tbakra 2.jpg" alt="Image 2"></div>
<div class="slide"><img src="../../../Asset/Catagories/tbarka 3.avif" alt="Image 3"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Plage Tabarka</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2025-10-06</strong></div>
...
<input type="text" name="destination" value="Plage Tabarka" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2025-10-06" readonly>
</div>
<div class="field-group">
...
<input type="text" name="voyageurs" value="3 Adultes, 2 Enfants" readonly>
