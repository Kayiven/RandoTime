...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/Kairouan_Mosque.webp" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/Kairouan_Mosque 1.jpg" alt="Image 2"></div>
<div class="slide"><img src="../../../Asset/Catagories/Kairouan_Mosque 2.jpg" alt="Image 3"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Kairouan Mosque</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2026-01-09</strong></div>
<div class="info-item"><span>Adultes</span><BR><strong>5</strong></div>
<div class="info-item"><span>Enfants</span><BR><strong>3</strong></div>
<div class="info-item"><span>Prix </span><BR><strong>155.00 TND</strong></div>
...
<p>🚌 <strong>Bus</strong> collectif : Départ à 7h45 depuis Tunis centre.</p>
</div>
...
<input type="text" name="destination" value="Kairouan Mosque" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2026-01-09" readonly>
</div>
<div class="field-group">
<label for="Price">Prix</label>
<input type="text" name="price" value="155.00 TND" readonly>
</div>
<div class="field-group">
<label>Voyageurs</label>
<div class="person-select">
<input type="text" name="voyageurs" value="5 Adultes, 3 Enfants" readonly>
...
<input type="hidden" name="Adults" id="adulteInput" value="5">
<input type="hidden" name="Enfants" id="enfantInput" value="3">
