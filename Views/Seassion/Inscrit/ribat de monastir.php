...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/ribat_de_monastir.webp" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/ribat_de_monastir 1.png" alt="Image 2"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Ribat de monastir</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2025-10-24</strong></div>
<div class="info-item"><span>Adultes</span><BR><strong>2</strong></div>
<div class="info-item"><span>Enfants</span><BR><strong>1</strong></div>
<div class="info-item"><span>Prix </span><BR><strong>160.00 TND</strong></div>
...
<input type="text" name="destination" value="Ribat de monastir" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2025-10-24" readonly>
</div>
<div class="field-group">
<label for="Price">Prix</label>
<input type="text" name="price" value="160.00 TND" readonly>
</div>
<div class="field-group">
