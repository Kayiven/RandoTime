...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/canyon_Midès.jpg" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/canyon Midès 1.jpg" alt="Image 2"></div>
<div class="slide"><img src="../../../Asset/Catagories/canyon Midès 2.webp" alt="Image 3"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Canyon Midès</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2026-01-13</strong></div>
<div class="info-item"><span>Adultes</span><BR><strong>2</strong></div>
<div class="info-item"><span>Enfants</span><BR><strong>3</strong></div>
<div class="info-item"><span>Prix </span><BR><strong>140.00 TND</strong></div>
...
<p>🚌 <strong>Bus</strong> collectif : Départ à 7h55 depuis Tunis centre.</p>
</div>
...
<input type="text" name="destination" value="canyon Midès" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2026-01-13" readonly>
</div>
<div class="field-group">
<label for="Price">Prix</label>
<input type="text" name="price" value="140.00 TND" readonly>
</div>
<div class="field-group">
<label>Voyageurs</label>
<div class="person-select">
<input type="text" name="voyageurs" value="2 Adultes, 3 Enfants" readonly>
...
<input type="hidden" name="Adults" id="adulteInput" value="2">
