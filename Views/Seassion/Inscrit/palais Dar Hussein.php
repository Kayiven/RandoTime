...
<title>Palais Dar Hussein</title>
...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/palais_Dar_Hussein.webp" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/palais Dar Hussein 1.jpg" alt="Image 2"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Palais Dar Hussein</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2026-02-25</strong></div>
<div class="info-item"><span>Adultes</span><BR><strong>2</strong></div>
<div class="info-item"><span>Enfants</span><BR><strong>3</strong></div>
<div class="info-item"><span>Prix </span><BR><strong>138.00 TND</strong></div>
...
<input type="text" name="destination" value="palais Dar Hussein" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2026-02-25" readonly>
</div>
<div class="field-group">
<label for="Price">Prix</label>
<input type="text" name="price" value="138.00 TND" readonly>
</div>
<div class="field-group">
