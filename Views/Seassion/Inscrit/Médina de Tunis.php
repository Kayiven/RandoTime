...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/Médina de Tunis.jpg" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/Médina de Tunis 2.jpg" alt="Image 2"></div>
<div class="slide"><img src="../../../Asset/Catagories/Médina de Tunis 1.jpg" alt="Image 3"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Médina de Tunis</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2026-02-07</strong></div>
<div class="info-item"><span>Adultes</span><BR><strong>6</strong></div>
<div class="info-item"><span>Enfants</span><BR><strong>4</strong></div>
<div class="info-item"><span>Prix </span><BR><strong>125.00 TND</strong></div>
...
<p>🚌 <strong>Bus</strong> collectif : Départ à 7h23 depuis Tunis centre.</p>
</div>
...
<input type="text" name="destination" value="Médina de Tunis" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2026-02-07" readonly>
</div>
<div class="field-group">
<label for="Price">Prix</label>
<input type="text" name="price" value="125.00 TND" readonly>
</div>
<div class="field-group">
<label>Voyageurs</label>
<div class="person-select">
<input type="text" name="voyageurs" value="6 Adultes, 4 Enfants" readonly>
...
<input type="hidden" name="Adults" id="adulteInput" value="6">
<input type="hidden" name="Enfants" id="enfantInput" value="4">
