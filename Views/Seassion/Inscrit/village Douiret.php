...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/village_Douiret.jpg" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/village_Douiret 1.webp" alt="Image 2"></div>
<div class="slide"><img src="../../../Asset/Catagories/village_Douiret 2.webp" alt="Image 3"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Village Douiret</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2025-10-30</strong></div>
...
<p>🚌 <strong>Bus</strong> collectif : Départ à 9h30 depuis Tunis centre.</p>
</div>
...
<input type="text" name="destination" value="village Douiret" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2025-10-30" readonly>
</div>
<div class="field-group">
...
<input type="text" name="voyageurs" value="4 Adultes, 1 Enfants" readonly>
