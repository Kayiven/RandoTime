...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/Chebika.webp" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/Chebika 1.webp" alt="Image 2"></div>
<div class="slide"><img src="../../../Asset/Catagories/Chebika 2.webp" alt="Image 3"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Chebika</h2>
...
<div class="info-item"><span>Prix </span><BR><strong>198.00 TND</strong></div>
...
<p>🚌 <strong>Bus</strong> collectif : Départ à 7h21 depuis Tunis centre.</p>
</div>
...
<input type="text" name="destination" value="Chebika" readonly>
</div>
<div class="field-group">
...
<input type="text" name="price" value="198.00 TND" readonly>
</div>
<div class="field-group">
