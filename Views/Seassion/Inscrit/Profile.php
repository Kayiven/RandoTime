...
<div class="sidebar">
<h2>Dashboard</h2>
<div class="category active">Controle Compte</div>
<div class="submenu">
<a href="./Profile.php" class="active">View Profile</a>
<a href="#">View paiement</a>
<a href="#">View commentaire</a></div>
<div class="category active">Options</div>
<div class="submenu">
<a href="../../../DataBase/Actions/disconnect-sys.php">Disconnect</a></div>
</div></div>
