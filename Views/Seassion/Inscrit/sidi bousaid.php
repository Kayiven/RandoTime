...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/sidi_bou_said.webp" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/sidi_bou_said 1.jpg" alt="Image 2"></div>
<div class="slide"><img src="../../../Asset/Catagories/sidi_bou_said 2.jpg" alt="Image 3"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Sidi bousaid</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2025-12-11</strong></div>
<div class="info-item"><span>Adultes</span><BR><strong>2</strong></div>
<div class="info-item"><span>Enfants</span><BR><strong>1</strong></div>
<div class="info-item"><span>Prix </span><BR><strong>185.00 TND</strong></div>
...
<p>🚌 <strong>Bus</strong> collectif : Départ à 7h25 depuis Tunis centre.</p>
</div>
...
<input type="text" name="destination" value="sidi bousaid" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2025-12-11" readonly>
</div>
<div class="field-group">
<label for="Price">Prix</label>
<input type="text" name="price" value="185.00 TND" readonly>
</div>
<div class="field-group">
