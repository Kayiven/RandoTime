...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/ksar-Ghilane.jpeg" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/ksar-Ghilane 1.jpg" alt="Image 2"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à ksar Ghilane</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2026-01-15</strong></div>
<div class="info-item"><span>Adultes</span><BR><strong>5</strong></div>
<div class="info-item"><span>Enfants</span><BR><strong>4</strong></div>
<div class="info-item"><span>Prix </span><BR><strong>108.00 TND</strong></div>
...
<p>🚌 <strong>Bus</strong> collectif : Départ à 7h33 depuis Tunis centre.</p>
</div>
...
<input type="text" name="destination" value="ksar Ghilane" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2026-01-15" readonly>
</div>
<div class="field-group">
<label for="Price">Prix</label>
<input type="text" name="price" value="108.00 TND" readonly>
</div>
<div class="field-group">
<label>Voyageurs</label>
<div class="person-select">
<input type="text" name="voyageurs" value="5 Adultes, 4 Enfants" readonly>
