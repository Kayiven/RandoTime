...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/port_El_Kantaoui.webp" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/Port El Kantaoui 2.jpeg" alt="Image 2"></div>
<div class="slide"><img src="../../../Asset/Catagories/Port El Kantaoui 3.jpg" alt="Image 3"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Port El Kantaoui</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2025-10-18</strong></div>
<div class="info-item"><span>Adultes</span><BR><strong>3</strong></div>
<div class="info-item"><span>Enfants</span><BR><strong>1</strong></div>
<div class="info-item"><span>Prix </span><BR><strong>170.00 TND</strong></div>
...
<input type="text" name="destination" value="port El Kantaoui" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2025-10-18" readonly>
</div>
<div class="field-group">
<label for="Price">Prix</label>
<input type="text" name="price" value="170.00 TND" readonly>
</div>
<div class="field-group">
