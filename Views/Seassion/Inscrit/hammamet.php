...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/hammamet.webp" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/hammamet 1.jpg" alt="Image 2"></div>
<div class="slide"><img src="../../../Asset/Catagories/hammamet 2.jpeg" alt="Image 3"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Hammamet</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2026-03-20</strong></div>
<div class="info-item"><span>Adultes</span><BR><strong>4</strong></div>
<div class="info-item"><span>Enfants</span><BR><strong>4</strong></div>
<div class="info-item"><span>Prix </span><BR><strong>180.00 TND</strong></div>
...
<p>🚌 <strong>Bus</strong> collectif : Départ à 7h35 depuis Tunis centre.</p>
</div>
...
<input type="text" name="destination" value="hammamet" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2026-03-20" readonly>
</div>
<div class="field-group">
<label for="Price">Prix</label>
<input type="text" name="price" value="180.00 TND" readonly>
</div>
<div class="field-group">
<label>Voyageurs</label>
<div class="person-select">
<input type="text" name="voyageurs" value="4 Adultes, 4 Enfants" readonly>
...
<input type="hidden" name="Adults" id="adulteInput" value="4">
