...
<title>Archeologique dougga</title>
...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/archeologique_dougga.webp" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/archeologique_dougga 2.jpg" alt="Image 2"></div>
<div class="slide"><img src="../../../Asset/Catagories/archeologique_dougga 3.jpg" alt="Image 3"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Archeologique dougga</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2025-10-31</strong></div>
...
<p>🚌 <strong>Bus</strong> collectif : Départ à 7h30 depuis Tunis centre.</p>
</div>
...
<input type="text" name="destination" value="archeologique dougga" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2025-10-31" readonly>
</div>
<div class="field-group">
...
<input type="text" name="voyageurs" value="2 Adultes, 1 Enfants" readonly>
