...
<!-- SLIDER -->
<div class="slider">
<div class="slide active"><img src="../../../Asset/Catagories/Zriba Olia 1.jpg" alt="Image 1"></div>
<div class="slide"><img src="../../../Asset/Catagories/Zriba Olia 2.jpg" alt="Image 2"></div>
</div>

<!-- CONTAINER -->
<div class="container">
<h2>Réservation - Randonnée à Zriba Olia</h2>

<!-- INFO SECTION -->
<div class="info">
<div class="info-item"><span>Date</span><BR><strong>2025-10-22</strong></div>
<div class="info-item"><span>Adultes</span><BR><strong>1</strong></div>
<div class="info-item"><span>Enfants</span><BR><strong>3</strong></div>
<div class="info-item"><span>Prix </span><BR><strong>135.00 TND</strong></div>
...
<p>🚌 <strong>Bus</strong> collectif : Départ à 7h10 depuis Tunis centre.</p>
</div>
...
<input type="text" name="destination" value="Zriba Olia" readonly>
</div>
<div class="field-group">
<label for="depart">Date de départ</label>
<input type="date" name="date_start" value="2025-10-22" readonly>
</div>
<div class="field-group">
<label for="Price">Prix</label>
<input type="text" name="price" value="135.00 TND" readonly>
</div>
<div class="field-group">
<label>Voyageurs</label>
<div class="person-select">
<input type="text" name="voyageurs" value="1 Adultes, 3 Enfants" readonly>
